...
_G.packer_plugins = {
  ...
  embark = {
    loaded = true,
    path = "/Users/jojo/.local/share/nvim/site/pack/packer/start/embark",
  ...
  ["nvim-ts-context-commentstring"] = {
    loaded = true,
    path = "/Users/jojo/.local/share/nvim/site/pack/packer/start/nvim-ts-context-commentstring",
  ...
  ["vim-solidity"] = {
    loaded = true,
    path = "/Users/jojo/.local/share/nvim/site/pack/packer/start/vim-solidity",
